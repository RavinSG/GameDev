...
public:
	...
	// ProcessInput, Update, LateUpdate, and Draw will simply be passed 
	// through methods. They will call the corresponding names methods of
	// the active scene.
	void ProcessInput();
	...
	// Transitions to scene with specific id.
	void SwitchTo(unsigned int id);
	
	// Removes scene from the state machine.
